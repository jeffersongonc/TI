<h1>Data Analysis - IA</h1>

<h3>Análise, tratamento, treinamento de modelos (Tree e KNN) e simulação de dados,.</h3>
...
<a href = "https://scikit-learn.org/stable/user_guide.html">SKLearn</a></br>
